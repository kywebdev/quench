...
<html lang="en">
    <head>
        <title>Work - Herr's | quench</title>
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-2 col-md-6">
                        <div class="hero__text">
                            <h1 class="hero__text__heading animated fadeInUpShort delay-250">Herr’s</h1>
                            <div class="animated fadeInUpShort delay-500">
                                <p class="hero__text__subheading animated lineHeight delay-500">Snacktime, gametime, anytime — when there are good times to be had, Break Out the Herr’s.</p>
                            </div>
                            <div class="hero__text__capabilities animated fadeInUpShort delay-750">
                                <ul>
                                    <li>Work Shown - Break Out the Herr’s TV</li>
                                    <li>OOH</li>
                                    <li>Social</li>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="hero__img animated fadeInUpMd slow delay-500">
                            <picture>
                                <source media="(max-width: 575px)" srcset="img/herrs-work-hero-mobile.jpg">
                                <img src="img/herrs-work-hero-desktop.jpg" alt="" class="animated shrinkIn slow delay-500">
                            </picture>
                        </div>
                    </div>
                </div>
                ...
                <div class="work__full-width animatedParent animateOnce">
                    <div class="work__full-width__video animated fadeInUpMd slow delay-250" id="video-1">
                        <div class="work__full-width__video__poster">
                            <img src="img/herrs-poster-6.jpg" alt="" class="animated shrinkIn slow delay-250" />
                            ...
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/herrs-work-1.jpg" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/herrs-work-2.jpg" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/herrs-work-3.jpg" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/herrs-work-4.jpg" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/herrs-work-5.jpg" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                        </div>
