(function($) {
    ...
    $(document).ready(function() {
        ...
        // hide/show partners slider dots
        function ourPartnersSliderDots(width) {
            if ($('.our-partners__slider .slick-track').children().length < 6) {
                $('.our-partners__slider .slick-dots').hide();
            } else {
                $('.our-partners__slider .slick-dots').show();
            }
        }
        ourPartnersSliderDots( $(window).width() );
        $(window).on('resize', function() {
            ourPartnersSliderDots( $(this).width() );
        });
        ...
        $('.footer-left__nav li').addClass('animated fadeInUpShort');
    ...
    // add animations to results p tags to account for wp tinyMCE editor
    $('.challenge-solution__challenge .col-md-7 p').addClass('animated lineHeight delay-250');
    $('.challenge-solution__solution__text p').addClass('animated lineHeight delay-750');
    $('.--page-trends .hero__text p').addClass('animated lineHeight slow delay-500');

    // counter
    var valueAnimDuration = 4;
    var valueAnimTicks = 200;

    var $counters = $('.about-result__text__percentage__num, .about-result__text__heading code, .results-section__subheading p code, .results-section__text p code, .results-section__percentages__num code');
