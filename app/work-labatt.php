...
<html lang="en">
    <head>
        <title>Work - Labatt | quench</title>
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-2 col-md-6">
                        <div class="hero__text">
                            <h1 class="hero__text__heading animated fadeInUpShort delay-250">Labatt</h1>
                            <div class="animated fadeInUpShort delay-500">
                                <p class="hero__text__subheading animated lineHeight delay-500">Allowing hockey fans to show their true colors with a few Blues.</p>
                            </div>
                            <div class="hero__text__capabilities animated fadeInUpShort delay-750">
                                <ul>
                                    <li>Work Shown - City NHL Designs</li>
                                    <li>Detroit Outdoor</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="hero__img animated fadeInUpMd slow delay-500">
                            <picture>
                                <source media="(max-width: 575px)" srcset="img/labatt-work-hero-mobile.jpg">
                                <img src="img/labatt-work-hero-desktop.jpg" alt="" class="animated shrinkIn slow delay-500">
                            </picture>
                        </div>
                    </div>
                </div>
            ...
            <section class="work">
                <div class="work__full-width animatedParent animateOnce">
                    <div class="work__full-width__img animated fadeInUpMd slow delay-250">
                        <img src="img/labatt-work-1.jpg" alt="" class="animated shrinkIn slow delay-250" />
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/labatt-work-2.jpg" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
