    ...
    <body class="work-gallery dark-theme nav-not-opened work-modal-not-opened">
        ...
        <main>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="hero__img animated fadeInUpMd slow delay-500">
                            <picture>
                                <source media="(max-width: 575px)" srcset="img/sunmaid-work-hero-mobile-1.jpg">
                                <img src="img/sunmaid-work-hero-desktop-1.jpg" alt="" class="animated shrinkIn slow delay-500">
                            </picture>
                        </div>
                    </div>
                </div>
            ...
            <section class="work">
                <div class="work__full-width animatedParent animateOnce">
                    <div class="work__full-width__video animated fadeInUpMd slow delay-250" id="video-1">
                        <div class="work__full-width__video__poster">
                            <img src="img/sunmaid-poster-1.jpg" alt="" class="animated shrinkIn slow delay-250" />
                            ...
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/sunmaid-work-1.png" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="work__gallery --three-up --green">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__video animated workFrame slow delay-250" id="video-2">
                                        <div class="work__gallery__video__poster">
                                            <img src="img/sunmaid-poster-2.jpg" alt="" class="animated workImg slow delay-250" />
                                            <div class="work__gallery__video__poster__play"></div>
                                        </div>
                                        <div class="work__gallery__video__video">
                                            <div style="padding:177.78% 0 0 0;position:relative;">
                                                <iframe src="https://player.vimeo.com/video/667514854?h=bfb1e79293&title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__video animated workFrame slow delay-250" id="video-3">
                                        <div class="work__gallery__video__poster">
                                            <img src="img/sunmaid-poster-3.jpg" alt="" class="animated workImg slow delay-250" />
                                            <div class="work__gallery__video__poster__play"></div>
                                        </div>
                                        <div class="work__gallery__video__video">
                                            <div style="padding:177.78% 0 0 0;position:relative;">
                            ...
                            <div class="col-md-4">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__video animated workFrame slow delay-250" id="video-4">
                                        <div class="work__gallery__video__poster">
                                            <img src="img/sunmaid-poster-4.jpg" alt="" class="animated workImg slow delay-250" />
                                            <div class="work__gallery__video__poster__play"></div>
                                        </div>
                                        <div class="work__gallery__video__video">
                                            <div style="padding:177.78% 0 0 0;position:relative;">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="animatedParent animateOnce">
                                    <div class="work__gallery__img animated workFrame slow delay-250">
                                        <img src="img/sunmaid-work-2.png" alt="" class="animated workImg slow delay-250" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            (function($) {
                $(document).ready(function() {
                    ...
                    // video 4
                    if ($('#video-4 iframe').length) {
                        var video4_iframe = document.querySelector('#video-4 iframe');
                        var video4_player = new Vimeo.Player(video4_iframe);
                        $('#video-4 .work__gallery__video__poster').on('click', function() {
                            $(this).fadeOut();
                            video4_player.play();
                        });
                        video4_player.on('ended', function() {
                            $('#video-4 .work__gallery__video__poster').fadeIn();
                        });
                    }
                });
            })(jQuery);
